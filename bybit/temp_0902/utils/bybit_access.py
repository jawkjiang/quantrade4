...
if __name__ == '__main__':
    ...
    print(get_tickers(http))
    print(get_kline(http, 'BTCUSDT', '1', 10, 0, 0))
    print(get_marginBalance(http))
    print(place_order(http, 'BTCUSDT', 'Buy', 0))
    print(close_position(http, 'BTCUSDT', 'Buy'))
